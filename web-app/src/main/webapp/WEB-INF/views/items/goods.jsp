...
<section class="content">
        ...
        <div class="row item-body">
            ...
            <div class='col-xs-3 thumbnail item-content-thumbnail'>
                ...
                <div class="item-infomation text-center">
                    <h4>Thumbnail</h4>
                    <label>Description:</label><p>The .img-thumbnail class creates a thumbnail of the image:</p>
                    <label>Quantity:</label><p>12</p>
    ...
    <!-- CART MODAL -->
    <div class="modal" id="item-cart-modal" tabindex="-1" role="dialog" aria-labelledby="Modal-Label" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form>
                        <table class="table table-hover">
                            ...
                            <tbody>
                            <tr>
                                <td><img src="${resourceURL}/images/carousel/1.jpg" alt="1-jpg" width="50" height="50"/></td>
                                <td>Thumbnail</td>
                                <td>
