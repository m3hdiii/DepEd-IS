...
public class EquipmentInfoController extends AbstractMainController<EquipmentInfo, Long> {
    ...
    public ModelAndView createAction(@Valid EquipmentInfo entity) {
        ...
        ResponseEntity<EquipmentInfo> response = makeCreateRestRequest(entity, BASE_NAME, HttpMethod.POST, EquipmentInfo.class);
    ...
    public ModelAndView renderInfo(@PathVariable(ID_STRING_LITERAL) Long aLong) {
        ResponseEntity<EquipmentInfo> response = makeFetchByIdRequest(BASE_NAME, HttpMethod.POST, aLong, EquipmentInfo.class);
    ...
    public ModelAndView renderUpdatePage(@PathVariable(ID_STRING_LITERAL) Long aLong) {
        ResponseEntity<EquipmentInfo> response = makeFetchByIdRequest(BASE_NAME, HttpMethod.POST, aLong, EquipmentInfo.class);
        EquipmentInfo item = response.getBody();
        return new ModelAndView(UPDATE_VIEW_PAGE, BASE_NAME, item);
    }

    @Override
    public ModelAndView updateAction(Long aLong, EquipmentInfo entity) {
        entity.setEquipmentInfoId(aLong);
