...
public class BorrowRequestController extends AbstractMainController<BorrowRequest, Long> {
    ...
    public ModelAndView createAction(@Valid BorrowRequest entity) {
        ...
        ResponseEntity<BorrowRequest> response = makeCreateRestRequest(entity, BASE_NAME, HttpMethod.POST, BorrowRequest.class);
    ...
    public ModelAndView renderInfo(@PathVariable(ID_STRING_LITERAL) Long aLong) {
        ResponseEntity<BorrowRequest> response = makeFetchByIdRequest(BASE_NAME, HttpMethod.POST, aLong, BorrowRequest.class);
    ...
    public ModelAndView renderUpdatePage(@PathVariable(ID_STRING_LITERAL) Long aLong) {
        ResponseEntity<BorrowRequest> response = makeFetchByIdRequest(BASE_NAME, HttpMethod.POST, aLong, BorrowRequest.class);
        BorrowRequest item = response.getBody();
    ...
    public ModelAndView updateAction(Long aLong, BorrowRequest entity) {
        entity.setBorrowRequestId(aLong);
